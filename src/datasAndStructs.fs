...
\ general constants
80 constant MAX_VOICES                  \ Maximum simultaneous voices 
48000 constant SYNTH_RATE
268435456 constant ENV_MAX              \  Maximum envelope value
1000 constant MAX_WAVETABLES 1000       \ Maximum wavetables
16 constant MAX_ARP_NOTES               \ Maximum notes in arpeggio
...
enum LoopMode {
0 constant LOOP_OFF
1 constant LOOP_FORWARD     \ Left -> Right (Default)
2 constant LOOP_PINGPONG    \ Back and Forth
3 constant LOOP_REVERSE     \ Right -> Left
